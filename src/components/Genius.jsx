    ...
    const fetchQuizzes = async () => {
      ...
      try {
        ...
        for (let i = 0; i < count; i++) {
          ...
          const participantsCount = await contract.getQuizParticipantsCount(i); // Fetch participants count
          ...
          quizzesArray.push({
            ...
            participants: participantsCount.toNumber(), // Add participants count
          });
        }
